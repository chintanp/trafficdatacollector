...
app_server <- function( input, output, session ) {
  ...
  summaryInputs <- callModule(mod_summaryModule_server, "summaryModule_ui_1", GlobalData)
  callModule(mod_tapInputModule_server, "tapInputModule_ui_1", GlobalData, formInputs, tableInputs, summaryInputs)
